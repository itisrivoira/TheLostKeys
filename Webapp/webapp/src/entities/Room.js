...
import { EnigmaCtx, RunCtx, RoomNameCtx, DoneCtx, CloseCtx, ScoreCtx} from "../components/components";
...
const Room = ({name, evType}) => {
	...
	const { setClose } = useContext(CloseCtx);
	const { setScore } = useContext(ScoreCtx);
